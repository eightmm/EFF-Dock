...
evaluation. Pure confidence selects 290 poses below \(2\,\angstrom\) among
393 complexes, compared with 285 for Vina+DG and 291 for the historical
...
PoseBusters (225/308; 67.84--77.70\%).
...
The median RMSD of pure-confidence selections is \(1.156\,\angstrom\) on
Astex and \(1.211\,\angstrom\) on PoseBusters. Learned ranking improves over
the same-candidate Vina+DG baseline on PoseBusters but not uniformly across
...
Oracle-80 success exceeds 94\% on every dataset, leaving gaps of 18.82 and
21.76 percentage points between pure-confidence top-1 and oracle coverage on
Astex and PoseBusters. Thus most benchmark complexes have a
...
rotatable bonds (\(N=113\)). These paired declines indicate that larger
ligands stress both fragment-pose generation and candidate selection.
