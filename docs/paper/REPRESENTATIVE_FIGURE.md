...
input column. Generation and refinement are enclosed in separate large boxes;
...
under its heading. Confidence displays three distinct recorded poses, with
...
the three displayed coordinates and their source provenance. The primary selector
ranks eligible
...
Generation times and refinement iterations are labeled separately. The four
...
workflow progresses from left to right. Refinement step 0 equals the generated t = 1 pose.
