...
- 과거 디렉터리별 캡션에는 이전 페이지 번호와 폐기된 그림 설명이 남아 있다. 현재 제출용 매핑은 이 문서와 captions.json을 기준으로 한다.
...
- 원본: [07_recent_model_comparison.pdf](../recent_benchmarks/07_recent_model_comparison.pdf)
...
- 원본: [01_stage_ablation.pdf](../20260919/01_stage_ablation.pdf)
...
- 원본: [complexity_overview.pdf](../20260920/complexity_overview.pdf)
...
- 원본: [pose_order_comparison.pdf](../combined_panels/pose_order_comparison.pdf)
...
- 원본: [pose_budget_refined.pdf](../20260920/pose_budget_refined.pdf)
...
- 원본: [02_guidance_budget.pdf](../20260919/02_guidance_budget.pdf)
...
- 원본: [05_runtime_memory.pdf](../20260919/05_runtime_memory.pdf)
...
- 원본: [03_pocket_prior_robustness.pdf](../20260919/03_pocket_prior_robustness.pdf)
...
- 원본: [training_relatedness.pdf](../combined_panels/training_relatedness.pdf)
...
- 원본: [06_training_exposure.pdf](../20260919/06_training_exposure.pdf)
...
- 원본: [sequence_performance.pdf](../sequence_overlap/sequence_performance.pdf)
...
- 원본: [paired_uncertainty.pdf](../manuscript_support/paired_uncertainty.pdf)
...
- 원본: [04_candidate_bottleneck.pdf](../20260919/04_candidate_bottleneck.pdf)
...
- 원본: [complexity_failure_explanation.pdf](../20260920/complexity_failure_explanation.pdf)
