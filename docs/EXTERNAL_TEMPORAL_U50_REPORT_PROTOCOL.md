...
- Refinement: the already-saved adaptive physical-refinement trajectory, at
  most 100 steps.
- Cohorts: PhiBench `N=203`, FoldBench `N=66`, and the OpenBind clean
  pocket-redocking cohort `N=860`.
...
The selector is the stable minimum U50-predicted RMSD over the 100 poses. It is
applied independently to the saved pre-refinement (`step_000`) and
