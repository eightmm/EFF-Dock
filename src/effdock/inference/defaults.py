...
# The public deployment budget is N100/S10/sigma2. The packaged confidence
# checkpoint was trained on an N80/S25/sigma0.5 bank; that historical training
# distribution remains recorded in its model card and confidence-preparation
# workflow.
